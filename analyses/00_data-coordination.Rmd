...
For some mysterious reason `merged_covid_usa.dta` file is not being downloaded? Raise with osf / package maintainer?
...
dir.create(file.path("data-raw/Spatial"), showWarnings = FALSE)
